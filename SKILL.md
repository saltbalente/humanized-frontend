...
description: "Anti-vibe-coded frontend design skill with a Design DNA engine for unique, niche-aware UI. Use when building, designing, reviewing, or refactoring websites, landing pages, SaaS, dashboards, portfolios, e-commerce, blogs, React, Next.js, Vue, Svelte, Tailwind, or shadcn/ui. Triggers include humanize UI, anti-AI design, unique landing, niche-aware design, brutalism, editorial, swiss minimal, art deco, y2k, terminal UI, organic eco, vaporwave, japanese ma, riso print, blueprint, monochrome noir, kill purple gradient, humanize copy, accessibility, focus states, mobile touch feel, motion, design tokens, CSS variables, variable fonts, texture, shadows, and visually distinct frontend work."
